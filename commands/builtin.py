...
def _show_help():
    ...
    print(f"  {BOLD}{BRIGHT_CYAN}║{RESET}                                              {BOLD}{BRIGHT_CYAN}║{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}╠══════════════════════════════════════════════╣{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}║{RESET}  {DIM}Fitur Advanced (Tahap 5):{RESET}                  {BOLD}{BRIGHT_CYAN}║{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}║{RESET}                                              {BOLD}{BRIGHT_CYAN}║{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}║{RESET}    {BOLD}{YELLOW}cmd > file{RESET}    {DIM}Output ke file (overwrite){RESET}  {BOLD}{BRIGHT_CYAN}║{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}║{RESET}    {BOLD}{YELLOW}cmd >> file{RESET}   {DIM}Output ke file (append){RESET}     {BOLD}{BRIGHT_CYAN}║{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}║{RESET}    {BOLD}{YELLOW}cmd < file{RESET}    {DIM}Input dari file{RESET}             {BOLD}{BRIGHT_CYAN}║{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}║{RESET}    {BOLD}{YELLOW}cmd1 | cmd2{RESET}   {DIM}Pipe output ke cmd lain{RESET}     {BOLD}{BRIGHT_CYAN}║{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}║{RESET}                                              {BOLD}{BRIGHT_CYAN}║{RESET}")
    print(f"  {BOLD}{BRIGHT_CYAN}╚══════════════════════════════════════════════╝{RESET}")
    print()
